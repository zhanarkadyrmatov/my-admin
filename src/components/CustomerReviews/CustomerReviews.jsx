                ...
                return (
                  <div key={item.id} className='flex flex-col gap-[10px]'>
                    <div className='flex items-center gap-[10px] pt-[10px] pb-[5px]'>
                      <img className='w-[50px] h-[50px] object-cover rounded-full' src={item?.author?.photo || 'https://images.vexels.com/media/users/3/140752/isolated/preview/17e31e592ab23bb0e8b2c0e76c0a4361-male-profile-avatar-5.png'} alt="" />
                      <div className='flex flex-col gap-[2px]'>
                        <h4 className='text-[15px] leading-[20px] text-[#222222] font-bold'>{item?.author?.name}</h4>
                    ...
                    <div className='flex flex-col gap-[6px]'>
                      <p className='text-[14px] leading-[16px] text-[#222222] font-normal opacity-70'>{item?.created_at}</p>
                      <p className='text-[14px] leading-[16px] text-[#222222] font-normal'>{item?.text}</p>
                      {item?.photo && (
                        <img className='w-[100%] h-[150px] rounded-[12px] object-cover' src={item?.photo} alt="" />
                      )}
                    </div>
                  </div>
                )
