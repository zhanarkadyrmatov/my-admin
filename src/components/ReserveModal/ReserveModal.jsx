    ...
    <>
      <div className="fixed top-0 left-0 h-full w-full flex items-center justify-center z-[1000]">
        <div
          ...
          className="absolute top-0 left-0 h-full w-full bg-[#000] opacity-50"
        />
        {modalValue ? (
          <div className="bg-white absolute rounded-[15px] w-[90%] max-w-[1200px] h-[70%] p-[20px] flex flex-col gap-2 overflow-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[20px] 3xl:grid-cols-4">
              {fields?.map((item) => (
                <div
                  key={item.id}
                  className="w-full relative shadow-lg rounded-[15px]"
                >
          ...
          <div className="absolute w-[90%] max-w-[521px] min-h-[242px] left-[50%] top-[50%] transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg p-[20px]">
            <div className="grid grid-rows-1 gap-y-[12px]">
              ...
              <div className="flex flex-col md:flex-row justify-center items-center gap-[12px]">
                <NavLink
                  ...
                  state={{ reserve: false }}
                  onClick={() => setReserve(false)}
                  className="py-[11px] px-[20px] w-full rounded-[8px] bg-gray-300 text-base font-medium leading-6 text-center"
                >
                  Несуществующий
                </NavLink>
                <NavLink
                  ...
                  state={{ reserve: true }}
                  onClick={() => setReserve(false)}
                  className="text-center py-[11px] px-[20px] w-full rounded-[8px] bg-gradient-to-br from-purple-700 to-purple-600 text-white bg-opacity-90 whitespace-nowrap"
                >
