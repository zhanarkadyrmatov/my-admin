...
function Login() {
  ...
  return (
    <div
      className="Login dark:bg-[#17171E] dark:text-[#000]"
      style={{ marginTop: "30px" }}
    >
      <div className="Login__container dark:bg-[#212130] dark:text-[#fff]">
        <p className="Login__p--hint">
          Войти вы можете только зарегистрированным <br /> пользователем
        </p>
        ...
        <label>
          ...
          <input
            ...
            className={cm(
              "Login__input",
              "dark:bg-[#212130]  dark:text-[#fff]",
              { "Login__input--error": email.error }
            )}
          />
        ...
        <label className="relative">
          ...
          <input
            ...
            className={cm(
              "Login__input",
              "dark:bg-[#212130]  dark:text-[#fff]",
              { "Login__input--error": password.error }
            )}
          />
          <span
            className="absolute right-[5px] top-[75%] transform -translate-y-1/2 cursor-pointer w-6 h-6"
