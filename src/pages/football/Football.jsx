          ...
          <div className="">
            ...
            <div className="bg-white p-[20px]">
              <div className="grid grid-cols-3 gap-[10px]">
                ...
                <div className="grid justify-items-center">
                  <div className="mx-[20px] my-[10px] w-full h-[150px] image-upload flex flex-col items-center justify-center p-4 bg-gray-100 rounded shadow-md">
                    {selectedImage ? (
                      <img
                        src={selectedImage}
                        alt="Uploaded"
                        className="w-[236px] h-[130px] object-cover rounded-md"
                      />
                    ) : (
                      <label htmlFor="upload" className="cursor-pointer">
                        <BiSolidCameraPlus size={30} />
              ...
              <div className="flex flex-col gap-y-[5px]">
                ...
                <select
                  ...
                  id=""
                >
                  <option className="py-[10px] text-[14px]" value="">Мини поле</option>
            ...
            <div className="grid gap-[5px] ">
              ...
              <div>
                <input
                  type="text"
                  className="w-full bg-[#F0F0F0] py-[10px] px-[20px] rounded-[8px] flex justify-between items-center focus:outline-none focus:shadow-outline"
                  placeholder="Добавьте типы футбольных полей"
                />
                <div className="relative">
                  <IoIosArrowDown
                    size={20}
                    className="absolute right-[2%] bottom-[1.500vh]"
                  />
                </div>
              </div>
            </div>
            <div className="grid gap-[5px]">
              <div className="w-full bg-[#F0F0F0] py-[5px] px-[5px] rounded-[8px] flex justify-between items-center ">
                <h4 className="font-size-15 font-weight-400 line-height-17-24 text-left pl-[10px] text[#222222]">
                  Мини поле
                </h4>
            ...
            <div className="flex gap-[10px] items-center mt-[10px] mx-[20px]">
            ...
            <div className="p-[8px] rounded-[8px] bg-[#7384E8] mx-[20px] mt-[20px]">
